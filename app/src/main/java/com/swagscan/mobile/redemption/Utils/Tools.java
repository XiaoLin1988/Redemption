...
public class Tools {
    ...
    public static void setConfiguration(Context context, String key, String value) {
        SharedPreferences mPrefs = context.getSharedPreferences(Constants.KEY_CONF, Context.MODE_PRIVATE);
        SharedPreferences.Editor prefsEditor = mPrefs.edit();
        prefsEditor.putString(key, value);
        prefsEditor.commit();
    }

    public static String getConfiguration(Context context, String key) {
        SharedPreferences mPrefs = context.getSharedPreferences(Constants.KEY_CONF, Context.MODE_PRIVATE);
        String conf = mPrefs.getString(key, "");
        return conf;
    }
}